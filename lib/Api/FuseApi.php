...
class FuseApi
{
    ...
    /**
     * Operation getRecommendedFinancialInstitutions
     *
     * @param  \FuseClient\Model\GetRecommendedFinancialInstitutionsRequest $get_recommended_financial_institutions_request get_recommended_financial_institutions_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getRecommendedFinancialInstitutions'] to see the possible values for this operation
     *
     * @throws \FuseClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \FuseClient\Model\GetRecommendedFinancialInstitutionsResponse
     */
    public function getRecommendedFinancialInstitutions($get_recommended_financial_institutions_request = null, string $contentType = self::contentTypes['getRecommendedFinancialInstitutions'][0])
    {
        list($response) = $this->getRecommendedFinancialInstitutionsWithHttpInfo($get_recommended_financial_institutions_request, $contentType);
        return $response;
    }

    /**
     * Operation getRecommendedFinancialInstitutionsWithHttpInfo
     *
     * @param  \FuseClient\Model\GetRecommendedFinancialInstitutionsRequest $get_recommended_financial_institutions_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getRecommendedFinancialInstitutions'] to see the possible values for this operation
     *
     * @throws \FuseClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \FuseClient\Model\GetRecommendedFinancialInstitutionsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getRecommendedFinancialInstitutionsWithHttpInfo($get_recommended_financial_institutions_request = null, string $contentType = self::contentTypes['getRecommendedFinancialInstitutions'][0])
    {
        $request = $this->getRecommendedFinancialInstitutionsRequest($get_recommended_financial_institutions_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\FuseClient\Model\GetRecommendedFinancialInstitutionsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\FuseClient\Model\GetRecommendedFinancialInstitutionsResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\FuseClient\Model\GetRecommendedFinancialInstitutionsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\FuseClient\Model\GetRecommendedFinancialInstitutionsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\FuseClient\Model\GetRecommendedFinancialInstitutionsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getRecommendedFinancialInstitutionsAsync
     *
     * @param  \FuseClient\Model\GetRecommendedFinancialInstitutionsRequest $get_recommended_financial_institutions_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getRecommendedFinancialInstitutions'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRecommendedFinancialInstitutionsAsync($get_recommended_financial_institutions_request = null, string $contentType = self::contentTypes['getRecommendedFinancialInstitutions'][0])
    {
        return $this->getRecommendedFinancialInstitutionsAsyncWithHttpInfo($get_recommended_financial_institutions_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getRecommendedFinancialInstitutionsAsyncWithHttpInfo
     *
     * @param  \FuseClient\Model\GetRecommendedFinancialInstitutionsRequest $get_recommended_financial_institutions_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getRecommendedFinancialInstitutions'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRecommendedFinancialInstitutionsAsyncWithHttpInfo($get_recommended_financial_institutions_request = null, string $contentType = self::contentTypes['getRecommendedFinancialInstitutions'][0])
    {
        $returnType = '\FuseClient\Model\GetRecommendedFinancialInstitutionsResponse';
        $request = $this->getRecommendedFinancialInstitutionsRequest($get_recommended_financial_institutions_request, $contentType);
    ...
    /**
     * Create request for operation 'getRecommendedFinancialInstitutions'
     *
     * @param  \FuseClient\Model\GetRecommendedFinancialInstitutionsRequest $get_recommended_financial_institutions_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getRecommendedFinancialInstitutions'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getRecommendedFinancialInstitutionsRequest($get_recommended_financial_institutions_request = null, string $contentType = self::contentTypes['getRecommendedFinancialInstitutions'][0])
    {



        $resourcePath = '/v1/financial_connections/institutions/recommended';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($get_recommended_financial_institutions_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($get_recommended_financial_institutions_request));
            } else {
                $httpBody = $get_recommended_financial_institutions_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * Operation searchFinancialInstitutions
     *
     * @param  \FuseClient\Model\SearchFinancialInstitutionsRequest $search_financial_institutions_request search_financial_institutions_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['searchFinancialInstitutions'] to see the possible values for this operation
     *
     * @throws \FuseClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \FuseClient\Model\SearchFinancialInstitutionsResponse
     */
    public function searchFinancialInstitutions($search_financial_institutions_request = null, string $contentType = self::contentTypes['searchFinancialInstitutions'][0])
    {
        list($response) = $this->searchFinancialInstitutionsWithHttpInfo($search_financial_institutions_request, $contentType);
        return $response;
    }

    /**
     * Operation searchFinancialInstitutionsWithHttpInfo
     *
     * @param  \FuseClient\Model\SearchFinancialInstitutionsRequest $search_financial_institutions_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['searchFinancialInstitutions'] to see the possible values for this operation
     *
     * @throws \FuseClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \FuseClient\Model\SearchFinancialInstitutionsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchFinancialInstitutionsWithHttpInfo($search_financial_institutions_request = null, string $contentType = self::contentTypes['searchFinancialInstitutions'][0])
    {
        $request = $this->searchFinancialInstitutionsRequest($search_financial_institutions_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\FuseClient\Model\SearchFinancialInstitutionsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\FuseClient\Model\SearchFinancialInstitutionsResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\FuseClient\Model\SearchFinancialInstitutionsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\FuseClient\Model\SearchFinancialInstitutionsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\FuseClient\Model\SearchFinancialInstitutionsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation searchFinancialInstitutionsAsync
     *
     * @param  \FuseClient\Model\SearchFinancialInstitutionsRequest $search_financial_institutions_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['searchFinancialInstitutions'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchFinancialInstitutionsAsync($search_financial_institutions_request = null, string $contentType = self::contentTypes['searchFinancialInstitutions'][0])
    {
        return $this->searchFinancialInstitutionsAsyncWithHttpInfo($search_financial_institutions_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation searchFinancialInstitutionsAsyncWithHttpInfo
     *
     * @param  \FuseClient\Model\SearchFinancialInstitutionsRequest $search_financial_institutions_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['searchFinancialInstitutions'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchFinancialInstitutionsAsyncWithHttpInfo($search_financial_institutions_request = null, string $contentType = self::contentTypes['searchFinancialInstitutions'][0])
    {
        $returnType = '\FuseClient\Model\SearchFinancialInstitutionsResponse';
        $request = $this->searchFinancialInstitutionsRequest($search_financial_institutions_request, $contentType);
    ...
    /**
     * Create request for operation 'searchFinancialInstitutions'
     *
     * @param  \FuseClient\Model\SearchFinancialInstitutionsRequest $search_financial_institutions_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['searchFinancialInstitutions'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function searchFinancialInstitutionsRequest($search_financial_institutions_request = null, string $contentType = self::contentTypes['searchFinancialInstitutions'][0])
    {



        $resourcePath = '/v1/financial_connections/institutions/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($search_financial_institutions_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($search_financial_institutions_request));
            } else {
                $httpBody = $search_financial_institutions_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * Operation selectFinancialInstitutions
     *
     * @param  \FuseClient\Model\SelectFinancialInstitutionsRequest $select_financial_institutions_request select_financial_institutions_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['selectFinancialInstitutions'] to see the possible values for this operation
     *
     * @throws \FuseClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \FuseClient\Model\SelectFinancialInstitutionsResponse
     */
    public function selectFinancialInstitutions($select_financial_institutions_request = null, string $contentType = self::contentTypes['selectFinancialInstitutions'][0])
    {
        list($response) = $this->selectFinancialInstitutionsWithHttpInfo($select_financial_institutions_request, $contentType);
        return $response;
    }

    /**
     * Operation selectFinancialInstitutionsWithHttpInfo
     *
     * @param  \FuseClient\Model\SelectFinancialInstitutionsRequest $select_financial_institutions_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['selectFinancialInstitutions'] to see the possible values for this operation
     *
     * @throws \FuseClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \FuseClient\Model\SelectFinancialInstitutionsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function selectFinancialInstitutionsWithHttpInfo($select_financial_institutions_request = null, string $contentType = self::contentTypes['selectFinancialInstitutions'][0])
    {
        $request = $this->selectFinancialInstitutionsRequest($select_financial_institutions_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\FuseClient\Model\SelectFinancialInstitutionsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\FuseClient\Model\SelectFinancialInstitutionsResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\FuseClient\Model\SelectFinancialInstitutionsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\FuseClient\Model\SelectFinancialInstitutionsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\FuseClient\Model\SelectFinancialInstitutionsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation selectFinancialInstitutionsAsync
     *
     * @param  \FuseClient\Model\SelectFinancialInstitutionsRequest $select_financial_institutions_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['selectFinancialInstitutions'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function selectFinancialInstitutionsAsync($select_financial_institutions_request = null, string $contentType = self::contentTypes['selectFinancialInstitutions'][0])
    {
        return $this->selectFinancialInstitutionsAsyncWithHttpInfo($select_financial_institutions_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation selectFinancialInstitutionsAsyncWithHttpInfo
     *
     * @param  \FuseClient\Model\SelectFinancialInstitutionsRequest $select_financial_institutions_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['selectFinancialInstitutions'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function selectFinancialInstitutionsAsyncWithHttpInfo($select_financial_institutions_request = null, string $contentType = self::contentTypes['selectFinancialInstitutions'][0])
    {
        $returnType = '\FuseClient\Model\SelectFinancialInstitutionsResponse';
        $request = $this->selectFinancialInstitutionsRequest($select_financial_institutions_request, $contentType);
    ...
    /**
     * Create request for operation 'selectFinancialInstitutions'
     *
     * @param  \FuseClient\Model\SelectFinancialInstitutionsRequest $select_financial_institutions_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['selectFinancialInstitutions'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function selectFinancialInstitutionsRequest($select_financial_institutions_request = null, string $contentType = self::contentTypes['selectFinancialInstitutions'][0])
    {



        $resourcePath = '/v1/financial_connections/institutions/select';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($select_financial_institutions_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($select_financial_institutions_request));
            } else {
                $httpBody = $select_financial_institutions_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
