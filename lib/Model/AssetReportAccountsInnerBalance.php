...
/**
 * AssetReportAccountsInnerBalance Class Doc Comment
 *
 * @category Class
 * @package  FuseClient
 * @author   OpenAPI Generator team
 ...
 */
class AssetReportAccountsInnerBalance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AssetReport_accounts_inner_balance';
    ...
    */
     ...
     * Sets available
     *
     * @param float|null $available Amount after factoring in pending balances
     *
     * @return self
     */
     ...
     * Sets current
     *
     * @param float|null $current Amount without factoring in pending balances
     *
     * @return self
     */
