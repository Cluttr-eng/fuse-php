...
/**
 * MigrateFinancialConnectionsAggregatorConnectionDataMx Class Doc Comment
 *
 * @category Class
 * @description Details of the MX connection to migrate into the unified Fuse API.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class MigrateFinancialConnectionsAggregatorConnectionDataMx implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MigrateFinancialConnectionsAggregatorConnectionData_mx';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['user_guid'] === null) {
            $invalidProperties[] = "'user_guid' can't be null";
        }
     ...
     * Sets user_guid
     *
     * @param string $user_guid The unique identifier (GUID) of the user within the MX platform.
     *
     * @return self
     */
     ...
     * Sets member_guid
     *
     * @param string|null $member_guid The unique identifier (GUID) of the member (connection) associated with the user within the MX platform.
     *
     * @return self
     */
