...
class FinancialConnectionsAccountLiability implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'additional_balances' => '\FuseClient\Model\FinancialConnectionsAccountCachedBalance[]',
        'remote_data' => 'object',
    ...
    protected static $setters = [
        ...
        'subtype' => 'setSubtype',
        'balance' => 'setBalance',
        'additional_balances' => 'setAdditionalBalances',
    ...
    protected static $getters = [
        ...
        'subtype' => 'getSubtype',
        'balance' => 'getBalance',
        'additional_balances' => 'getAdditionalBalances',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('additional_balances', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets additional_balances
     *
     * @return \FuseClient\Model\FinancialConnectionsAccountCachedBalance[]|null
     */
    public function getAdditionalBalances()
    {
        return $this->container['additional_balances'];
    }

    /**
     * Sets additional_balances
     *
     * @param \FuseClient\Model\FinancialConnectionsAccountCachedBalance[]|null $additional_balances An array of additional balances. This may be used for investment type accounts where the user can have multiple balances across different currencies.
     *
     * @return self
     */
    public function setAdditionalBalances($additional_balances)
    {
        if (is_null($additional_balances)) {
            throw new \InvalidArgumentException('non-nullable additional_balances cannot be null');
        }
        $this->container['additional_balances'] = $additional_balances;
    ...
    public function setRemoteData($remote_data)
    {
        if (is_null($remote_data)) {
            throw new \InvalidArgumentException('non-nullable remote_data cannot be null');
        }
