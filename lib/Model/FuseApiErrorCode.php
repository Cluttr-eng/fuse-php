...
class FuseApiErrorCode
{
    ...
    public const MISSING_SOPHTRON_USER_ID_HEADER = 'missing_sophtron_user_id_header';

    public const MISSING_SOPHTRON_ACCESS_KEY_HEADER = 'missing_sophtron_access_key_header';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::MISSING_SOPHTRON_USER_ID_HEADER,
            self::MISSING_SOPHTRON_ACCESS_KEY_HEADER,
