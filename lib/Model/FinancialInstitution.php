 ...
 */
class FinancialInstitution implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinancialInstitution';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Unique identifier for the financial institution id.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Name for the financial institution.
     *
     * @return self
     */
     ...
     * Sets website
     *
     * @param string|null $website Website of the financial institution.
     *
     * @return self
     */
