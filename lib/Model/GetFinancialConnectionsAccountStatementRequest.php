...
/**
 * GetFinancialConnectionsAccountStatementRequest Class Doc Comment
 *
 * @category Class
 * @package  FuseClient
 * @author   OpenAPI Generator team
 ...
 */
class GetFinancialConnectionsAccountStatementRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetFinancialConnectionsAccountStatementRequest';
    ...
    */
     ...
     *
     * @param string $remote_account_id The remote account id to retrieve the statement for.
     *
     * @return self
     */
     ...
     * Sets date
     *
     * @param string|null $date The year and month for the account statement to be retrieved in YYYY-MM.
     *
     * @return self
     */
