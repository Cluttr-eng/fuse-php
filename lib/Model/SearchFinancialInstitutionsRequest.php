...
/**
 * SearchFinancialInstitutionsRequest Class Doc Comment
 *
 * @category Class
 * @package  FuseClient
 * @author   OpenAPI Generator team
 ...
 */
class SearchFinancialInstitutionsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SearchFinancialInstitutionsRequest';
    ...
    */
     ...
     * Sets search_term
     *
     * @param string $search_term The search term, ie wells fargo.
     *
     * @return self
     */
