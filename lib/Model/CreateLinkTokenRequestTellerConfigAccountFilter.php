 ...
 */
class CreateLinkTokenRequestTellerConfigAccountFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateLinkTokenRequest_teller_config_accountFilter';
    ...
    {
        $this->setIfExists('depository', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($depository)) {
            throw new \InvalidArgumentException('non-nullable depository cannot be null');
        }
