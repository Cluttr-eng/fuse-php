 ...
 */
class AssetReportAccountsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AssetReport_accounts_inner';
    ...
    */
     ...
     * Sets remote_id
     *
     * @param string|null $remote_id The remote account ID of the account.
     *
     * @return self
     */
