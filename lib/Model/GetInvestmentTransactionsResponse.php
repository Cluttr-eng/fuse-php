 ...
 */
class GetInvestmentTransactionsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetInvestmentTransactionsResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('investment_transactions', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($investment_transactions)) {
            throw new \InvalidArgumentException('non-nullable investment_transactions cannot be null');
        }
     ...
     *
     * @param float|null $total_transactions The total number of transactions within the specified date range.
     *
     * @return self
     */
