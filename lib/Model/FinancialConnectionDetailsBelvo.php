...
/**
 * FinancialConnectionDetailsBelvo Class Doc Comment
 *
 * @category Class
 * @description Data needed to query data from Belvo
 * @package  FuseClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class FinancialConnectionDetailsBelvo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinancialConnectionDetails_belvo';
    ...
    */
     ...
     * Sets link_id
     *
     * @param string $link_id The identifier of the link for Belvo.
     *
     * @return self
     */
     ...
     * Sets institution
     *
     * @param string|null $institution The identifier of the institution for Belvo.
     *
     * @return self
     */
