...
/**
 * FinancialConnectionsOwnerAddressesInnerData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FinancialConnectionsOwnerAddressesInnerData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinancialConnectionsOwner_addresses_inner_data';
    ...
    */
     ...
     * Sets full_address
     *
     * @param string|null $full_address Full address of the owner
     *
     * @return self
     */
     ...
     * Sets region
     *
     * @param string|null $region Region of the address
     *
     * @return self
     */
     ...
     * Sets street
     *
     * @param string|null $street Street of the address
     *
     * @return self
     */
