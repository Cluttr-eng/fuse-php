...
/**
 * DeleteFinancialConnectionResponse Class Doc Comment
 *
 * @category Class
 * @package  FuseClient
 * @author   OpenAPI Generator team
 ...
 */
class DeleteFinancialConnectionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeleteFinancialConnectionResponse';
    ...
    */
     ...
     *
     * @param string $financial_connection_id Id of the deleted financial connection
     *
     * @return self
     */
     ...
     * Sets access_token
     *
     * @param string $access_token Access token of the deleted financial connection
     *
     * @return self
     */
