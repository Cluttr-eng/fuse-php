 ...
 */
class GetFinancialInstitutionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetFinancialInstitutionResponse';
