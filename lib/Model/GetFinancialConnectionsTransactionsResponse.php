 ...
 */
class GetFinancialConnectionsTransactionsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetFinancialConnectionsTransactionsResponse';
    ...
    */
     ...
     *
     * @param float $total_transactions The total number of transactions available within the date range specified. If total_transactions is larger than the size of the transactions array, more transactions are available and can be fetched
     *
     * @return self
     */
