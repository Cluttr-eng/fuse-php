 ...
 */
class EvalConsumerRiskReportRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EvalConsumerRiskReportRequest';
    ...
    */
     ...
     * Sets window_size
     *
     * @param float $window_size The size of the window for training
     *
     * @return self
     */
    ...
    public function setEvents($events)
    {
        ...
        if ((count($events) < 1)) {
            throw new \InvalidArgumentException('invalid length for $events when calling EvalConsumerRiskReportRequest., number of items must be greater than or equal to 1.');
        }
