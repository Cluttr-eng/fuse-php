 ...
 */
class EvalConsumerRiskReportRequestEventsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EvalConsumerRiskReportRequest_events_inner';
    ...
    */
     ...
     * Sets account_id
     *
     * @param string $account_id The id of the account that event belongs to
     *
     * @return self
     */
