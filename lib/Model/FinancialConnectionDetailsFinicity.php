...
/**
 * FinancialConnectionDetailsFinicity Class Doc Comment
 *
 * @category Class
 * @description Data needed to query data from Finicity.
 * @package  FuseClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class FinancialConnectionDetailsFinicity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinancialConnectionDetails_finicity';
    ...
    */
     ...
     * Sets customer_id
     *
     * @param string $customer_id The identifier of the customer for Finicity.
     *
     * @return self
     */
     ...
     *
     * @param string $institution_login_id The Finicity institution login id.
     *
     * @return self
     */
