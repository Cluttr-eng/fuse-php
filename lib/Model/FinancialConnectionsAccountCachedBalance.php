...
/**
 * FinancialConnectionsAccountCachedBalance Class Doc Comment
 *
 * @category Class
 * @package  FuseClient
 * @author   OpenAPI Generator team
 ...
 */
class FinancialConnectionsAccountCachedBalance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinancialConnectionsAccountCachedBalance';
    ...
    */
     ...
     * Sets current
     *
     * @param float|null $current Amount without factoring in pending balances, in cents. The format of this value is a double.
     *
     * @return self
     */
     ...
     *
     * @param string|null $last_updated_date The date of the last update to the balance.
     *
     * @return self
     */
