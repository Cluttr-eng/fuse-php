 ...
 */
class FinancialConnectionsInvestmentSecurity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinancialConnectionsInvestmentSecurity';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('close_price', $data ?? [], null);
    ...
    */
     ...
     * Sets remote_id
     *
     * @param string $remote_id Remote Id of the security, ie Plaid or Snaptrade security id
     *
     * @return self
     */
     ...
     * Sets symbol
     *
     * @param string $symbol The trading symbol for publicly traded securities, or a short identifier if available.
     *
     * @return self
     */
     ...
     * Sets isin
     *
     * @param string|null $isin The International Securities Identification Number (ISIN) uniquely identifies the security.
     *
     * @return self
     */
     ...
     * Sets sedol
     *
     * @param string|null $sedol The Stock Exchange Daily Official List (SEDOL) code uniquely identifies the security, primarily used in the United Kingdom and Ireland.
     *
     * @return self
     */
     ...
     * Sets cusip
     *
     * @param string|null $cusip The Committee on Uniform Securities Identification Procedures (CUSIP) number uniquely identifies the security, primarily used in the United States and Canada.
     *
     * @return self
     */
     ...
     * Sets close_price
     *
     * @param float|null $close_price The closing price of the security, in cents, at the end of the most recent trading day. The format of this value is a double.
     *
     * @return self
     */
    public function setClosePrice($close_price)
    {
        if (is_null($close_price)) {
            throw new \InvalidArgumentException('non-nullable close_price cannot be null');
        }
