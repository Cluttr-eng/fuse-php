...
/**
 * FinancialConnectionData Class Doc Comment
 *
 * @category Class
 * @package  FuseClient
 * @author   OpenAPI Generator team
 ...
 */
class FinancialConnectionData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinancialConnectionData';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id The financial connection id.
     *
     * @return self
     */
     ...
     * Sets institution_id
     *
     * @param string|null $institution_id The Fuse Institution ID associated with the financial connection
     *
     * @return self
     */
