 ...
 */
class GetInvestmentHoldingsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetInvestmentHoldingsRequest';
