...
class FinancialConnectionDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'sophtron' => '\FuseClient\Model\FinancialConnectionDetailsSophtron'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('sophtron', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets sophtron
     *
     * @return \FuseClient\Model\FinancialConnectionDetailsSophtron|null
     */
    public function getSophtron()
    {
        return $this->container['sophtron'];
    }

    /**
     * Sets sophtron
     *
     * @param \FuseClient\Model\FinancialConnectionDetailsSophtron|null $sophtron sophtron
     *
     * @return self
     */
    public function setSophtron($sophtron)
    {
        if (is_null($sophtron)) {
            throw new \InvalidArgumentException('non-nullable sophtron cannot be null');
        }
        $this->container['sophtron'] = $sophtron;
