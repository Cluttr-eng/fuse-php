 ...
 */
class InAppTransactionEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InAppTransactionEvent';
    ...
    public const EVENT_TYPE_IN_APP_TRANSACTION = 'in_app_transaction';
    ...
    {
        return [
            self::EVENT_TYPE_IN_APP_TRANSACTION,
        ];
    }
