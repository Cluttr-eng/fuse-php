...
/**
 * RefreshAssetReportResponse Class Doc Comment
 *
 * @category Class
 * @package  FuseClient
 * @author   OpenAPI Generator team
 ...
 */
class RefreshAssetReportResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RefreshAssetReportResponse';
    ...
    */
     ...
     *
     * @param string|null $asset_report_token A token that can be provided to endpoints such as /asset_report to fetch an asset report.
     *
     * @return self
     */
