...
/**
 * RefreshAssetReportRequest Class Doc Comment
 *
 * @category Class
 * @package  FuseClient
 * @author   OpenAPI Generator team
 ...
 */
class RefreshAssetReportRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RefreshAssetReportRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['days_requested']) && ($this->container['days_requested'] < 1)) {
            $invalidProperties[] = "invalid value for 'days_requested', must be bigger than or equal to 1.";
        }
     ...
     * Sets access_token
     *
     * @param string $access_token Access fuse token corresponding to the financial account to be refresh the Asset Report for.
     *
     * @return self
     */
     ...
     * Sets days_requested
     *
     * @param float|null $days_requested The maximum integer number of days of history to include in the Asset Report
     *
     * @return self
     */
    public function setDaysRequested($days_requested)
    {
        ...
        if (($days_requested > 731)) {
            throw new \InvalidArgumentException('invalid value for $days_requested when calling RefreshAssetReportRequest., must be smaller than or equal to 731.');
        }
        if (($days_requested < 1)) {
            throw new \InvalidArgumentException('invalid value for $days_requested when calling RefreshAssetReportRequest., must be bigger than or equal to 1.');
        }
