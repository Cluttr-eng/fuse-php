...
/**
 * FinancialConnectionDetailsSnaptrade Class Doc Comment
 *
 * @category Class
 * @description Data needed to query data from SnapTrade
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class FinancialConnectionDetailsSnaptrade implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinancialConnectionDetails_snaptrade';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['brokerage_authorization_id'] === null) {
            $invalidProperties[] = "'brokerage_authorization_id' can't be null";
        }
        if ($this->container['user_id'] === null) {
            $invalidProperties[] = "'user_id' can't be null";
        }
        if ($this->container['user_secret'] === null) {
            $invalidProperties[] = "'user_secret' can't be null";
        }
     ...
     *
     * @param string $brokerage_authorization_id Brokerage Authorization Id for SnapTrade
     *
     * @return self
     */
     ...
     * Sets user_id
     *
     * @param string $user_id User id for SnapTrade
     *
     * @return self
     */
     ...
     * Sets user_secret
     *
     * @param string $user_secret User secret for SnapTrade
     *
     * @return self
     */
