...
/**
 * FinancialConnectionsAccountBalance Class Doc Comment
 *
 * @category Class
 * @package  FuseClient
 * @author   OpenAPI Generator team
 ...
 */
class FinancialConnectionsAccountBalance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinancialConnectionsAccountBalance';
    ...
    */
     ...
     * Sets current
     *
     * @param float|null $current Amount in cents without factoring in pending balances. The format of this value is a double.
     *
     * @return self
     */
     ...
     *
     * @param string|null $iso_currency_code The ISO-4217 currency code of the balance.
     *
     * @return self
     */
     ...
     *
     * @param string|null $last_updated_date The last time the account balance was updated, represented as an ISO 8601 timestamp (YYYY-MM-DDTHH:mm:ssZ). This value may not be available for some accounts.
     *
     * @return self
     */
